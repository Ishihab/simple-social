...
Revision ID: ccc895c7923e
Revises: 
Create Date: 2026-08-14 19:25:01.656759
...
def upgrade() -> None:
    ...
    op.create_table('object_store_objects',
    sa.Column('id', sa.Uuid(), nullable=False),
    sa.Column('file_key', sa.String(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_object_store_objects_file_key'), 'object_store_objects', ['file_key'], unique=True)
    ...
    sa.Column('followee_id', fastapi_users_db_sqlalchemy.generics.GUID(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_table('user')
    op.drop_index(op.f('ix_object_store_objects_file_key'), table_name='object_store_objects')
